(function() {
    ...
    function stateConfig($stateProvider) {
        ...
        .state('record-sense-rapor-4', {
            parent: 'entity',
            url: '/record-sense-rapor-4?page&sort&search',
            data: {
                authorities: ['ROLE_USER'],
                pageTitle: 'facetrackerApp.recordSense.home.title'
            },
            views: {
                'content@': {
                    templateUrl: 'app/entities/record-sense/record-senses-rapor4.html',
                    controller: 'RecordSenseRapor4Controller',
                    controllerAs: 'vm'
                }
            },
            params: {
